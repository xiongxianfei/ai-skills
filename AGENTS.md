...
Reusable AI prompt skills for writing, translation, and productivity. Each skill is a SKILL.md file with YAML frontmatter — works with any AI model, installable as Codex slash commands.
...
.Codex-plugin/plugin.json ← plugin manifest (update version when releasing)
```
